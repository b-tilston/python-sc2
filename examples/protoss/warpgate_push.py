    ...
    async def warp_new_units(self, proxy):
        for warpgate in self.structures(UnitTypeId.WARPGATE).ready:
            ...
            if AbilityId.WARPGATETRAIN_ZEALOT in abilities:
                ...
                placement = await self.find_placement(AbilityId.WARPGATETRAIN_ZEALOT, pos, placement_step=1) #_STALKER
    ...
    async def on_step(self, iteration):
        ...
        if self.structures(UnitTypeId.PYLON).ready:
            ...
            if (
                ...
                await self.build(UnitTypeId.GATEWAY, near=pylon, 5)
...
##                    stalker.attack(self.enemy_start_locations[0])
        ...
        if (
            ...
            p = self.game_info.map_center.towards(self.enemy_start_locations[0], 20) #20
